...
const authSlice = createSlice({
    ...
    reducers: (create) => ({
        ...
        register: create.asyncThunk(async (data: TRegisterData) => registerUserApi(data),
        {
            pending: (state) => {
        ...
        forgotPassword: create.asyncThunk(async (data: TForgotPasswordData) => forgotPasswordApi(data),
        {
            pending: (state) => {
        ...
        resetPassword: create.asyncThunk(async (data: TResetPasswordData) => resetPasswordApi(data),
        {
            pending: (state) => {
